...
**修正ステータス**: ✅ 修正済み（ExcelJS: sha384ハッシュ付き、holiday_jp: @2.2.3にバージョン固定＋sha384ハッシュ付き、共にcrossorigin="anonymous"設定。v2.3.0以降はブラウザ用ビルドが廃止されたため@2.2.3を使用）
...
**修正ステータス**: ✅ 修正済み（#3 SRIの修正と同時に @2.2.3 にバージョン固定＋SRIハッシュ付与済み。v2.3.0以降ブラウザ用ビルド廃止のため@2.2.3を使用）
