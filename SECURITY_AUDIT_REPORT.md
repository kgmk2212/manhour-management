...
**修正ステータス**: ✅ 修正済み（ExcelJS: sha384ハッシュ付き、holiday_jp: @2.5.1にバージョン固定＋sha384ハッシュ付き、共にcrossorigin="anonymous"設定）
...
**修正ステータス**: ✅ 修正済み（#3 SRIの修正と同時に @2.5.1 にバージョン固定＋SRIハッシュ付与済み）
