...
export function renderMemberCalendar() {
    ...
    allDates.forEach(date => {
        ...
        const dateDisplay = isHoliday
            ? `${parseInt(m)}/${parseInt(day)} (${dayOfWeek})<span class="holiday-inline"> ${escapeHtml(holiday)}</span><span class="holiday-break"><br><span style="font-size: calc(12.5px * var(--ui-scale)); font-weight: normal;">${escapeHtml(holiday)}</span></span>`
