...
window.addEditEstimateMemberRow = EstimateEdit.addEditEstimateMemberRow;
window.removeEditEstimateMemberRow = EstimateEdit.removeEditEstimateMemberRow;
...
window.filterCalendarTaskList = Actual.filterCalendarTaskList;
window.selectCalendarTask = Actual.selectCalendarTask;
window.selectCalendarTaskFreeInput = Actual.selectCalendarTaskFreeInput;
window.clearCalendarTaskSelection = Actual.clearCalendarTaskSelection;
window.handleActualProcessChange = Actual.handleActualProcessChange;
