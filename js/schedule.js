    ...
    if (filteredSchedules.length === 0) {
        if (emptyMessage) {
            ...
            emptyMessage.innerHTML = hasFilters
                ? '<p>該当するスケジュールがありません</p><p style="font-size: calc(15px * var(--ui-scale)); color: #888;">フィルタ条件を変更してください</p>'
                : '<p>スケジュールがありません</p><p style="font-size: calc(15px * var(--ui-scale)); color: #888;">「+ 予定作成」ボタンから予定を追加してください</p>';
        }
