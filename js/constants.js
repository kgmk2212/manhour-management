...
// ============================================
// 実績の一括変更（js/actual-bulk.js）関連定数
// ============================================

export const BULK_EDIT = {
    UNDO_TOAST_MS: 8000,       // Undo トーストの表示時間
    PREVIEW_ROWS: 3,           // 一括編集プレビューの先頭表示件数
    COPY_PREVIEW_ROWS: 4,      // 複製プレビューの先頭表示件数
    DEFAULT_SHIFT_DAYS: 7,     // 日付シフトの初期値（日）
};
